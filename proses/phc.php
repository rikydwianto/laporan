<div class='content table-responsive'>
    ...
    <form method="post">
        ...
        <tr>
              <td>TGL PHC</td>
              <td><input type="date" class='form-control' id='tgl' onchange="tgl_ganti()" value='<?=$tgl?>' name='tgl'></td>
          </tr>
            <tr>
                <th>CABANG</th>
                <td>
                    <input type="text" value="<?=strtoupper($d['kode_cabang'])?>/<?=strtoupper($d['nama_cabang'])?>" readonly name="cabang" id="" class='form-control'>
                </td>
            </tr>
            <tr>
                <th>PIC</th>
                <td>
                    <input type="text" value="<?=$d['nama_karyawan']?>/<?=$d['nama_jabatan']?>" readonly name="pic" id="" class='form-control'>
                </td>
            </tr>
            <tr>
                <th>STATUS</th>
            ...
            <tr>
                <th>KETERANGAN</th>
                <td>
                    <textarea name="keterangan" <?=$readonly?> id="" cols="30" class='form-control' rows="10"><?=@$phc['keterangan_phc']?></textarea>
                </td>
            </tr>
            <tr>
                <th>&nbsp;</th>
                <td>
                    ...
                    if(mysqli_num_rows($qphc))
                    {
                        ...
                        $detaill = mysqli_fetch_array($detail)['id_detail'];
                        ?>
                        <a href="<?=$url.$menu."phc&detail&id=$phc[id]&tgl=$tgl&iddetail=$detaill"?>" class="btn btn-primary">ISI PHC</a>
                        <a href="<?=$url.$menu."phc&hapus&id=$phc[id]&tgl=$tgl"?>" class="btn btn-danger" onclick="return window.confirm('Jika anda menghapus PHC ini, maka ISI PHC juga akan terhapus, anda yakin??')">HAPUS</a>
                        <?php
                    }
                    else{
                        ?>
     ...
     if(isset($_GET['detail']) && isset($_GET['id'])){
        ...
        <form method="post">
            <div class='col-md-10'>
                ...
                $cek_detail = mysqli_fetch_array($cek_detail);
                ...
                <div class='col-md-6'>
                    <table class='table'>
                        <tr>
                            <td>SALDO KAS</td>
                            <td><input type="number" <?=$readonly?> name="kas" value="<?=$cek_detail['saldo_kas']?>" class='form-control' id=""></td>
                        </tr>
                        <tr>
                            <td>SALDO BANK</td>
                            <td><input type="number" <?=$readonly?> name="bank" value="<?=$cek_detail['saldo_bank']?>" class='form-control' id=""></td>
                        </tr>
                        <tr>
                            <td>PPI NOT ENTRY</td>
                            <td><input type="number" <?=$readonly?> name="ppi" value="<?=$cek_detail['ppi_not_entry']?>" class='form-control' id=""></td>
                        </tr>
                        <tr>
                            <td>KTP NO ENTRY</td>
                            <td><input type="number" <?=$readonly?> name="ktp" value="<?=$cek_detail['ktp_not_entry']?>" class='form-control' id=""></td>
                        </tr>
                        <tr>
                            <td>TOTAL CENTER </td>
                            <td><input type="number" <?=$readonly?> name="total_center" value="<?=$cek_detail['ctr_input']?>" class='form-control' id=""></td>
                        </tr>
                        <tr>
                            <td>TOTAL CENTER DTD </td>
                            <td><input type="number" <?=$readonly?> name="center_dtd" value="<?=$cek_detail['ctr_dtd']?>" class='form-control' id=""></td>
                        </tr>
                        <!-- <tr>
                            <td>TOTAL ANGGOTA </td>
                        ...
                        <tr>
                            ...
                            <td><input type="number" <?=$readonly?> name="total_agt_bayar" value="<?=$cek_detail['agt_bayar']?>" class='form-control' id=""></td>
                        </tr>
                        <tr>
                            <td>TOTAL ANGGOTA TIDAK BAYAR </td>
                            <td><input type="number" <?=$readonly?> name="total_agt_tidak_bayar" value="<?=$cek_detail['agt_tidak_bayar']?>" class='form-control' id=""></td>
                        </tr>
                        <tr>
                            <td>TOTAL AGT PAR</td>
                            <td><input type="number" <?=$readonly?> name="total_par" value="<?=$cek_detail['total_agt_par']?>" class='form-control' id=""></td>
                        </tr>
                        <tr>
                            <td>SISA MONITORIN H-3</td>
                            <td><input type="number" <?=$readonly?> name="monitoring" value="<?=$cek_detail['sisa_monitoring']?>" class='form-control' id=""></td>
                        </tr>
                ...
                <table class='table'>
                        ...
                        <tr>
                            ...
                            <td><input type="number" <?=$readonly?> name="pu" class='form-control' value="<?=$cek_detail['pu']?>" id=""></td>
                        </tr>
                        <tr>
                            <td>PK</td>
                            <td><input type="number" <?=$readonly?> name="pk" class='form-control' value="<?=$cek_detail['pk']?>" id=""></td>
                        </tr>
                        <tr>
                            <td>LWK </td>
                            <td><input type="number" <?=$readonly?> name="lwk" class='form-control' value="<?=$cek_detail['lwk']?>" id=""></td>
                        </tr>
                        <tr>
                            <td>UPK </td>
                            <td><input type="number" <?=$readonly?> name="upk" class='form-control' value="<?=$cek_detail['upk']?>" id=""></td>
                        </tr>
                      
                        <tr>
                            <td>ANGGOTA MASUK </td>
                            <td><input type="number" <?=$readonly?> name="anggota_masuk" class='form-control' value="<?=$cek_detail['agt_masuk']?>" id=""></td>
                        </tr>
                        <tr>
                            <td>ANGGOTA KELUAR </td>
                            <td><input type="number" <?=$readonly?> name="anggota_keluar" class='form-control' value="<?=$cek_detail['agt_keluar']?>" id=""></td>
                        </tr>
                        <tr>
                            <td>PENGECEKAN BUKU </td>
                            <td><input type="number" <?=$readonly?> name="cek_buku" class='form-control' value="<?=$cek_detail['cek_buku']?>" id=""></td>
                        </tr>
                        <tr>
                            <td>PENGECEKAN DISBURSE </td>
                            <td><input type="number" <?=$readonly?> name="cek_disburse" class='form-control' value="<?=$cek_detail['cek_disburse']?>" id=""></td>
                        </tr>
                        <tr>
                            <td>PENGECEKAN SIMPANAN </td>
                            <td><input type="number" <?=$readonly?> name="cek_saving" class='form-control' value="<?=$cek_detail['cek_simpanan']?>" id=""></td>
                        </tr>
                        <tr>
                            <td> </td>
                            <td>
                                ...
                                if($phc['status']=='konfirmasi'){
                                    ?>
                                <input type="submit" name="unkonfirmasi_phc" class='btn btn-danger' value="UN UPPROVE" onclick="" id="">

<?php
                                }elseif($phc['status']=='pending'){
                                    ?>
                                <input type="submit" name="konfirmasi_phc" class='btn btn-primary' value="KONFIRMASI" onclick="return window.confirm('Apakah semua sudah benar?')" id="">
                                <input type="submit" name="unkonfirmasi_phc" class='btn btn-danger' value="EDIT" onclick="" id="">
                                <?php
                                }elseif($phc['status']=='belum'){
                                    ?>
