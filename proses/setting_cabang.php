<div class="row">
    ...
    ?>
        ...
        <table>
            ...
            while ($staff = mysqli_fetch_assoc($q)) {
                $kary = mysqli_fetch_assoc(mysqli_query($con, "select id_karyawan from karyawan where id_cabang='$id_cabang' and nama_karyawan='$staff[staff]'"));
            ?>
                <tr>
                    <td><?= $no++ ?></td>
    ...
    ?>
        <form action="" method="post">
            ...
            <table class='table'>
                ...
                while ($staff = mysqli_fetch_assoc($q1)) {
