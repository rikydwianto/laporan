...
<div class='col-lg-12' id='rekap_semua'>
    ...
    <table class="table table-bordered" style="border: 1px;">
        ...
        while ($staff = mysqli_fetch_assoc($query)) {
            ...
            $anggotaminggu = mysqli_fetch_assoc($qagt);
            ...
            $anggotabulan = mysqli_fetch_assoc($qbulan);
            ...
            $anggotatahun = mysqli_fetch_assoc($qtahun);
            ...
            $cdisminggu = mysqli_fetch_assoc($qdisminggu);
            ...
            $cdisbulan = mysqli_fetch_assoc($qdisbulan);
            ...
            $cdistahun = mysqli_fetch_assoc($qdistahun);
