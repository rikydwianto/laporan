<div class='content table-responsive'>
    ...
    if(isset($_GET['tglawal']) || isset($_GET['tglakhir']))
   {
    ...
    <form action="">
        ...
        <input type="date" name='tglawal' value="<?=(isset($_GET['tglawal']) ?  $_GET['tglawal'] : date("Y-m-d"))?>"
            class="" />
        <input type="date" name='tglakhir' value="<?=(isset($_GET['tglakhir']) ?  $_GET['tglakhir'] : date("Y-m-d"))?>"
            class="" />
