  ...
  <a href='<?= $url . $menu ?>cabang&tambah_wilayah' class="btn btn-info" >
    ...
    <form action="" name='laporan_manual[]' method="post">
        <table class='table table-bordered'>
            ...
            while ($kar = mysqli_fetch_assoc($qkar)) {
                    ...
                    <tr>
                        ...
                        <td rowspan="1">
                            <table border="1" class="table">
                                ...
                                <?php
                                $tc = 0;
                                while ($center = mysqli_fetch_assoc($qcenter)) {
                                    ...
                                    $bayar_value = mysqli_fetch_assoc($qq);
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="hidden" class='form-control' style="width: 50px;" name="absen[<?= $kar['id_karyawan'] ?>][]" value="<?= $absen ?>" id="">
                        ...
                        <td>
                            ...
                            <textarea name="keterangan[]" class='form-control' id="" cols="15" rows="2">generate automate</textarea>
...
if (isset($_POST['laporan'])) {
    ...
    for ($i = 0; $i < count($hitung); $i++) {
        ...
        for ($a = 0; $a < $hitung_center; $a++) {
            ...
            VALUES (NULL, '$id_laporan', '$center[$a]', '$status', '$doa[$a]', '$agt[$a]', '$client[$a]', '$bayar[$a]', '$tidak_bayar[$a]', 'sukses', 't','$absen[$a]'); 
