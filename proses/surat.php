<div class='content table-responsive'>
    ...
    <?php
    $urut = mysqli_fetch_assoc(mysqli_query($con, "select max(no_urut) as no_urut from surat where id_cabang='$id_cabang' AND YEAR(tgl_surat) = YEAR(curdate()) "));
        ...
        <div class='col-md-12'>
            <form action="" method="post">
                ...
                <table class='table'>
                    <tr>
                        <td colspan="2">
                            <h2 style="text-align:center">Tambah Surat</h2>
                        </td>
