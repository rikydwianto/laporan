...
<div class='content table-responsive'>
    ...
    <a href="<?=$url."export/penarikan_simpanan.php?"?>upk&list=cari&tglawal=<?=$tglawal?>&tglakhir=<?=$tglakhir?>&cari=FILTER" class='btn btn-danger'>
