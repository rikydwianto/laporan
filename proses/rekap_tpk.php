            ...
            <table class='table table-bordered'>
                ...
                <tbody>
                    ...
                    if (isset($_GET['cari'])) {
                        ...
                        while ($kar = mysqli_fetch_assoc($q)) {
                            ...
                            $tpk = mysqli_fetch_assoc($tpk)['total'];
                            $total_tpk += $tpk;
                    ?>
                            <tr>
                                <td><?= $no++ ?></td>
                                ...
                                while ($tgl1 = mysqli_fetch_assoc($qtgl1)) {
                                    ...
                                    $hit = mysqli_fetch_assoc($qhit)['total'];
                                    if ($hit < 1) {
                                        $background = "#fc4935";
                                    } else $background = '';
                                ?>
                ...
                <tfoot>
                    <tr>
                        ...
                        ?>
                        <th colspan="1" style="text-align: center;"><?= $total_tpk ?></th </tr>
                </tfoot>
            </table>
        </div>
    </div>
