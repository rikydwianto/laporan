...
function center($con,$no_center,$doa,$status,$member,$anggota_center,$bayar,$id_cabang,$id_karyawan,$hari,$idlaporan,$jam)
{
  ...
  if(mysqli_num_rows($cari)){
    $d = mysqli_query($con,"UPDATE center SET hari='$hari',doa_center='$doa',status_center = '$status', member_center = '$member' , anggota_center = '$anggota_center' , center_bayar = '$bayar' , id_karyawan = '$id_karyawan', id_laporan='$idlaporan' , jam_center='$jam'  WHERE no_center = '$no_center' and id_cabang=$id_cabang; ");
  // echo "jalankan perintah edit";  
  }
  else{
  // echo "jalankan perintah tambah";  
    $d = mysqli_query($con,"INSERT INTO center (id_center, no_center, hari, doa_center, status_center, member_center,anggota_center, center_bayar, id_cabang, id_karyawan,id_laporan,jam_center) VALUES (NULL, '$no_center','$hari', '$doa', '$status', '$member', '$anggota_center','$bayar', '$id_cabang', '$id_karyawan','$idlaporan','$jam')");
  }
