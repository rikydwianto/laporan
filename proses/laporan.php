...
<div class="col-md-6">
	<div class="panel panel-default ">
		...
		<div class="panel-body post-body ">
			...
			<h2 class='page-header'>Lihat Laporan</h2>
			<hr />
			<form method=post>
				pilih bulan
				<select name='bln'>
...
<div class="col-md-6">
	<div class="panel panel-default ">
		...
		<div class="panel-body post-body " style="overflow: auto;">
			<h2 class='page-header'>Detail Laporan Center</h2>
			<hr />
			<?php
			...
			?>
				<div class="table-responsive">
					<table class="table table-bordered table-responsive">
						...
						$hitung_bayar = 0;
						$hitung_tdk_bayar = 0;
						while ($ambil = mysqli_fetch_assoc($q)) {
						?>
							<tr>
								<td><?php echo $no++ ?></td>
...
<div class="col-md-12 col-lg-12 ">
	<div class="panel panel-default ">
		...
		<div class="panel-body post-body  ">
			<h2>Rekap pembayaran anggota</h2>
			<hr />
			<div class='table-responsive'>
				<table class='table table-bordered'>
					...
					while ($bawah = mysqli_fetch_assoc($qcek)) {
						echo "<tr>";
						...
						for ($i = 1; $i < $tanggal + 1; $i++) {
							...
							$cek = mysqli_fetch_assoc($cari_cek);
