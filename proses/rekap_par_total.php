<div class='content table-responsive'>
    ...
    <div class="col-md-12">
        ...
        group by c.id_karyawan order by k.nama_karyawan");
            while ($delin = mysqli_fetch_assoc($q_delin)) {
                ...
                $total_nasabah = mysqli_fetch_assoc($total_nasabah)['total_nasabah'];
            ...
            ?>
                <tr>
                    ...
                    foreach ($q_hari as $hari) {
                        ...
                        $perhari = mysqli_fetch_assoc($perhari);
                    ?>
