...
<body>
    ...
    <table class='table' border="1">
        ...
        while ($simp = mysqli_fetch_array($penarikan)) {
            ...
            $cek_delin = mysqli_query($con,"select * from deliquency where id_cabang='$id_cabang' and id_detail_nasabah='$simp[id_detail_nasabah]' and tgl_input='$qtgl' order by tgl_input desc");
