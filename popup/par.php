...
<body>
    <div class='kertas'>
        ...
        SELECT d.*,k.nama_karyawan, a.penyelesaian_par,a.alasan FROM deliquency d 
        JOIN center c ON c.`no_center`=d.`no_center` 
        JOIN karyawan k ON k.`id_karyawan`=c.`id_karyawan`
LEFT JOIN alasan_par a ON d.id_detail_nasabah = a.id_detail_nasabah where d.tgl_input='$tgl' and c.id_cabang='$id_cabang' and d.id_cabang='$id_cabang' $q_tambah  $q_tambah1 order by k.nama_karyawan asc");
