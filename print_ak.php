    ...
    <div class='kertas'>
        ...
        <table>
           ...
           <tbody>
               ...
               where a.id_cabang='$id_cabang' and a.tgl_keluar and a.tgl_keluar between '$tgl_awal' and '$tgl_akhir' 
               group by a.id_nasabah order by a.tgl_keluar,k.nama_karyawan desc");
