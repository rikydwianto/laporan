...
<li>
    <a href="<?php echo $url . $menu ?>deliquency_sl" class="w3-bar-item w3-button"><i class="fas fa-globe-europe"></i>
        ANGGOTA PAR</a>
</li>
...
<li>
    <a href="<?php echo $url . $menu ?>list-monitoring" class="w3-bar-item w3-button"><i
            class="fas fa-globe-europe"></i> MONITORING</a>
</li>
<!-- 
		<li>
...
<li>
    <a href="<?php echo $url . $menu ?>penarikan_simpanan" class="w3-bar-item w3-button"><i class="fas fa-dollar"></i>
        Penarikan Simpanan</a>
</li>
<li>
    <a href="<?php echo $url ?>lokasi.php" class="w3-bar-item w3-button"><i class="fa fa-globe"></i> LOKASI</a>
</li>

<li><a href="<?php echo $url . $menu ?>setting" class="w3-bar-item w3-button"><i class="fa fa-gears"></i> Setting</a>
</li>
<li><a href="<?php echo $url . $menu ?>logout" class="w3-bar-item w3-button"><i class="fa fa-sign-out"></i> Logout</a>
</li>
...
<li>
    ...
    <ul class="nav nav-second-level">
        <li><a href="<?php echo $url . $menu ?>anggota" class="w3-bar-item w3-button"><i class="fa fa-users"></i>
                Anggota</a></li>
</li>
...
<li>
    <a href="<?php echo $url . $menu ?>setting_kelompok" class="w3-bar-item w3-button"><i class="fa fa-building"></i>
        Kelompok</a>
</li>
<li>
...
<li>
    <a href="<?php echo $url . $menu ?>perbaikan" class="w3-bar-item w3-button"><i class="fa fa-gear"></i> Perbaikan
        data</a>

</li>
<li>
    <a href="<?php echo $url . $menu ?>cashflow" class="w3-bar-item w3-button"><i class="fa fa-file-excel-o"></i>
        Cashflow</a>
...
<li>
    <a href="<?php echo $url . $menu ?>regional" class="w3-bar-item w3-button"><i class="fa fa-building"></i>
        Regional</a>
</li>
<li>
    <a href="<?php echo $url . $menu ?>daftar_wilayah" class="w3-bar-item w3-button"><i class="fa fa-globes"></i> Daftar
        Wilayah</a>
</li>
<li>
    <a href="<?php echo $url . $menu ?>daftar_nasabah" class="w3-bar-item w3-button"><i class="fa fa-users"></i> Daftar
        Nasabah</a>
</li>
<li>
    <a href="<?php echo $url . $menu ?>setting_cabang" class="w3-bar-item w3-button"><i class="fa fa-users"></i> SETTING
        CABANG</a>
</li>
</ul>
...
<li>
    ...
    <ul class="nav nav-second-level">
        <li>
            <a href="<?php echo $url . $menu ?>tmb_laporan" class="w3-bar-item w3-button"><i class="fa fa-plus"></i>
                Tambah Laporan</a>

        </li>

        <li>
            <a href="<?php echo $url . $menu ?>edit_laporan" class="w3-bar-item w3-button"><i class="fa fa-edit"></i>
                Edit Laporan</a>
...
<li>
    ...
    <ul class="nav nav-second-level">
        <li>
            <a href="<?php echo $url . $menu ?>blk_input" class="w3-bar-item w3-button"><i class="fa fa-plus"></i>
                BLK</a>

        </li>

        <li>
            <a href="<?php echo $url . $menu ?>par" class="w3-bar-item w3-button"><i class="fa fa-bar-chart"></i>
                Deliquency</a>

        </li>
        <li>
            <a href="<?php echo $url . $menu ?>par&anal_topup=ANALISA+TOPUP" class="w3-bar-item w3-button"><i
                    class="fa fa-bar-chart"></i> Top up Khusus</a>

        </li>
        <li>
            <a href="<?php echo $url . $menu ?>anal_bayar" class="w3-bar-item w3-button"><i class="fa fa-bar-chart"></i>
                Analisi Agt Tidak Bayar</a>
...
<li>
    <a href="<?php echo $url . $menu ?>detail_center" class="w3-bar-item w3-button"><i class="fa fa-font-awesome"></i>
        Data Wilayah</a>
</li>
<li>
...
<li>
    ...
    <ul class="nav nav-second-level">
        ...
        <li>
            <a href="<?php echo $url . $menu ?>setting_kelompok" class="w3-bar-item w3-button"><i
                    class="fa fa-building"></i> Kelompok</a>
        </li>
        <li>
            <a href="<?php echo $url . $menu ?>center" class="w3-bar-item w3-button"><i class="fa fa-users"></i>
                Center</a>

        </li>
        <li>
            <a href="<?php echo $url . $menu ?>cashflow" class="w3-bar-item w3-button"><i
                    class="fa fa-file-excel-o"></i> Cashflow</a>

        </li>
        <li>
            <a href="<?php echo $url . $menu ?>daftar_wilayah" class="w3-bar-item w3-button"><i
                    class="fa fa-globes"></i> Daftar Wilayah</a>
        </li>
        <li>
            <a href="<?php echo $url . $menu ?>daftar_nasabah" class="w3-bar-item w3-button"><i class="fa fa-users"></i>
                Daftar Nasabah</a>
        </li>
        <li>
            <a href="<?php echo $url . $menu ?>setting_cabang" class="w3-bar-item w3-button"><i class="fa fa-users"></i>
                SETTING CABANG</a>
        </li>
    </ul>
</li>
...
<li><a href="<?php echo $url . $menu ?>rekap_center" class="w3-bar-item w3-button"><i class="fa fa-build"></i> REKAP
        CENTER BAYAR</a></li>
<li>
    <a href="<?php echo $url ?>lokasi.php" class="w3-bar-item w3-button"><i class="fa fa-globe"></i> LOKASI</a>
</li>
...
<li>
    ...
    <ul class="nav nav-second-level">
        ...
        <li>
            <a href="<?php echo $url . $menu ?>rekap_par_total" class="w3-bar-item w3-button"><i
                    class="fa fa-bar-chart"></i> REKAP PAR</a>
...
<li>
    ...
    <ul class="nav nav-second-level">
        ...
        <li>
            <a href="<?php echo $url . $menu ?>sihara" class="w3-bar-item w3-button"><i class="fa fa-list"></i>
                SIHARA</a>
        </li>
        <li>
            <a href="<?php echo $url . $menu ?>detail_center" class="w3-bar-item w3-button"><i
                    class="fa fa-font-awesome"></i> Data Wilayah</a>
        </li>
        <li>
            <a href="<?php echo $url . $menu ?>rapih_file" class="w3-bar-item w3-button"><i class="fa fa-handphone"></i>
                Arsip MdisMo</a>
        </li>
        <li><a href="<?php echo $url . $menu ?>file" class="w3-bar-item w3-button"><i class="fa fa-folder"></i> FILE</a>
        </li>
        <li>
            <a href="<?php echo $url . $menu ?>setting_cabang" class="w3-bar-item w3-button"><i class="fa fa-users"></i>
                SETTING CABANG</a>
...
<li>
    ...
    <ul class="nav nav-second-level">
        ...
        <li><a href="<?php echo $url . $menu ?>rekap_center" class="w3-bar-item w3-button"><i class="fa fa-build"></i>
                REKAP CENTER BAYAR</a></li>
        <li><a href="<?php echo $url . $menu ?>rekap_tabungan" class="w3-bar-item w3-button"><i class="fa fa-build"></i>
                REKAP TABUNGAN</a></li>
        <li>
            <a href="<?php echo $url . $menu ?>rekap_tpk" class="w3-bar-item w3-button"><i class="fa fa-bar-chart"></i>
                REKAP ANGGOTA TPK</a>
        ...
        <li>
            <a href="<?php echo $url . $menu ?>tidak_bayar" class="w3-bar-item w3-button"><i
                    class="fa fa-bar-users"></i> AGT TIDAK BAYAR</a>
...
<li>
    ...
    <ul class="nav nav-second-level">
        ...
        <li>
            <a href="<?php echo $url . $menu ?>par_regional" class="w3-bar-item w3-button"><i
                    class="fa fa-bar-chart"></i> Deliquency</a>
